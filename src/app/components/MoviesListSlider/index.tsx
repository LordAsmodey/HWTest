      ...
      videos: [
        {
          ...
          sources: ['https://dj0vkl2i4vsbo.cloudfront.net/convert/wife_caught_husband/convertedwife.m3u8'],
        ...
        },
        {
          ...
          sources: ['https://sample.vodobox.net/skate_phantom_flex_4k/skate_phantom_flex_4k.m3u8'],
          subtitle: 'By Blender Foundation',
        ...
        },
        {
          ...
          sources: ['https://d1gnaphp93fop2.cloudfront.net/videos/multiresolution/rendition_new10.m3u8'],
          subtitle: 'By Google',
          thumb: 'https://storage.googleapis.com/gtv-videos-bucket/sample/images/ForBiggerEscapes.jpg',
        ...
        },
        {
          ...
          sources: ['https://assets.afcdn.com/video49/20210722/v_645516.m3u8'],
  ...
  return (
    <Layout>
      <FlatList
        ...
        horizontal
        pagingEnabled
        renderItem={({ item, index }) => VideoItem({ item, index, currentSlideIndex, handleVideoEnd })}
